...
$r = $pdo->query("select count(t.screen_name) as c, t.screen_name, u.profile_image_url, u.profile_background_color from tweets t, users u where t.screen_name = u.screen_name group by t.screen_name, u.profile_image_url order by c desc");
